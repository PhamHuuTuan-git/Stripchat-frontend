                ...
                <div className="w-full max-w-sm flex flex-col gap-6">
                    ...
                    <form className="flex flex-col gap-4" onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <div className="flex justify-end w-full">
                            <Link href="/forgot-password" className="text-sm text-zinc-400 hover:text-[#f23b75] transition-colors">
                                Forgot password?
                            </Link>
                        </div>
                    ...
                    <div className="flex items-center gap-4 py-2">
                        ...
                        <p className="text-zinc-500 text-xs text-center uppercase tracking-wider font-medium">Or log in with</p>
                        <div className="h-[1px] flex-1 bg-zinc-800" />
                    </div>
                    ...
                    <p className="text-center text-zinc-400 text-sm mt-4">
                        ...
                        <Link href="/register" className="text-[#f23b75] hover:text-pink-400 font-medium">
                            Sign up
                        </Link>
                    </p>
                </div>
